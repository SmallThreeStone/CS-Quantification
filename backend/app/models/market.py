...
class CollectRunLog(Base):
    __tablename__ = "collect_run_logs"
    ...
    real_field_count: Mapped[int] = mapped_column(Integer, default=0)
    fallback_field_count: Mapped[int] = mapped_column(Integer, default=0)
...
class StrategyConfig(Base):
    ...
    min_price_volatility_rate: Mapped[float] = mapped_column(Float, default=0.08)
